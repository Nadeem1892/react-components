...
const colors = {
  ...
  outline: {
    primary: "text-blue-500 border border-blue-500 hover:bg-blue-200",
    secondary: "text-gray-500 border border-gray-500 hover:bg-gray-200",
    success: "text-green-500 border border-green-500 hover:bg-green-200",
...
export const ATMButton: React.FC<Props> = ({
  size = "sm",
  children,
  onClick,
  color = "primary",
